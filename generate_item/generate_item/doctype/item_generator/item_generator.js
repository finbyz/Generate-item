...
// // // // // //                 }
// // // // // //                 // Hide default Save button to avoid a disabled/black button being visible
...
// // // // // //                                     indicator: "red"
// // // // // //                                 });
// // // // // //                                 frappe.ui.get_open_dialogs().forEach(dialog => dialog.hide());
// // // // // //                                 return;
// // // // // //                             }
    
// // // // // //                             // Proceed with save and set is_closed if no validation errors
// // // // // //                             frm.save().then(function() {
// // // // // //                                 frm.set_value("is_closed", 1).then(function() {
...
// // // // // //                         },
// // // // // //                         function() {
// // // // // //                             // Close confirmation dialog on cancel
// // // // // //                             frappe.ui.get_open_dialogs().forEach(dialog => dialog.hide());
// // // // // //                         }
// // // // // //                     );
// // // // // //                 });
// // // // // //             }
// // // // // //         } else {
// // // // // //             // Ensure Save button is available/visible when not creating with Sales Order
// // // // // //             try {
...
// // // // // //             if (frm.doc.is_create_with_sales_order === 1 && frm.doc.is_closed !== 1) {
// // // // // //                 frm.set_value("is_closed", 1);
// // // // // //                 // Perform a single save and submit
// // // // // //                 frm.save().then(() => {
// // // // // //                     frappe.show_alert("Document closed successfully.");
// // // // // //                     if (ctx && ctx.so_name) {
// // // // // //                         // Delay navigation to ensure all events complete
// // // // // //                         setTimeout(() => {
// // // // // //                             frappe.set_route('Form', 'Sales Order', ctx.so_name);
// // // // // //                         }, 1500); // Increased delay to avoid overlap
// // // // // //                     }
// // // // // //                 }).catch((err) => {
// // // // // //                     frappe.msgprint({
// // // // // //                         title: __("Error"),
// // // // // //                         message: __("Failed to close the document. Please try again."),
// // // // // //                         indicator: "red"
// // // // // //                     });
// // // // // //                 });
// // // // // //             } else if (frm.doc.is_closed === 1 && ctx && ctx.so_name) {
// // // // // //                 // If already closed, navigate directly
// // // // // //                 setTimeout(() => {
// // // // // //                     frappe.set_route('Form', 'Sales Order', ctx.so_name);
// // // // // //                 }, 1500);
// // // // // //             }
...
// // // // // //     console.log("Clearing attribute value fields for Item Generator:", frm.doc.name);
// // // // // //     for (let i = 1; i <= 28; i++) {
...
// // // // //                         // 🔥 FIX 1: Use proper save callback to handle dirty state
// // // // //                         frm.save().then(function() {
// // // // //                             // Success - form should automatically show as saved
// // // // //                             frm.refresh();
// // // // //                         }).catch(function(err) {
...
// // // // //         // Handle return routing logic (removed localStorage usage)
// // // // //         try {
// // // // //             // Use session storage or memory instead of localStorage
...
// // // // //         // 🔥 FIX 2: Avoid setting values in refresh that could mark form as dirty
// // // // //         if (
// // // // //             frm.doc.custom_conditional_description &&
// // // // //             frm.doc.short_description !== frm.doc.custom_conditional_description &&
// // // // //             !frm.doc.__islocal // Only update if document is saved
// // // // //         ) {
// // // // //             frm.set_value("short_description", frm.doc.custom_conditional_description);
// // // // //         }
...
// // // // //             load_template_attributes(frm, frm.doc.template_name, true);
// // // // //         } else if (frm.__attribute_meta_loaded__) {
// // // // //             // 🔥 FIX 3: Don't regenerate fields on refresh if form is saved
...
// // // // //             if (frm.doc.is_create_with_sales_order === 1 && frm.doc.is_closed !== 1) {
// // // // //                 frm.set_value("is_closed", 1);
// // // // //                 // 🔥 FIX 4: Save without additional refresh/reload
// // // // //                 frm.save().then(() => {
// // // // //                     frappe.show_alert("Document closed successfully.");
// // // // //                     if (ctx && ctx.so_name) {
// // // // //                         setTimeout(() => {
...
// // // // //     // 🔥 FIX 5: Add proper handling for item_descriptor without making form dirty
...
// // // // //     frm.set_value("custom_conditional_description", "");
// // // // //     frm.set_value("description", "");
// // // // //     // 🔥 FIX 6: Only mark as dirty if necessary
// // // // //     if (!frm.doc.__islocal) {
// // // // //         frm.dirty();
// // // // //     }
// // // // // }

// // // // // // ---------- Load template attributes and options ----------
...
// // // // //     // 🔥 PRESERVE GENERATED FIELDS: Don't clear item_code, description, short_description unless forced
...
// // // // //     // 🔥 ONLY CLEAR GENERATED FIELDS IF FORCED (complete reset)
// // // // //     if (force) {
...
// // // // // // ---------- Register attribute change handlers ----------
// // // // // var _events = {};
...
// // // //                             }).then(() => {
// // // //                                 return frm.submit(); // Submit to set docstatus = 1
// // // //                             }).then(() => {
// // // //                                 frappe.msgprint("This record has been saved and closed.");
// // // //                                 frm.reload_doc();
// // // //                             }).catch(function(err) {
// // // //                                 frappe.msgprint({
// // // //                                     title: __("Cannot Close"),
...
// // // //                                 });
// // // //                                 frappe.ui.get_open_dialogs().forEach(dialog => dialog.hide());
// // // //                                 console.error("Save/Close error:", err);
// // // //                             });
// // // //                         },
// // // //                         function() {
// // // //                             frappe.ui.get_open_dialogs().forEach(dialog => dialog.hide());
...
// // // //             }
// // // //         } catch (e) {
// // // //             console.error("Error in return routing:", e);
// // // //         }
...
// // // //             frm.doc.short_description !== frm.doc.custom_conditional_description &&
// // // //             !frm.doc.__islocal &&
// // // //             !frm.doc.__unsaved // Only update if not unsaved
// // // //         ) {
...
// // // //             // Handle closing and submission
// // // //             if (frm.doc.is_create_with_sales_order === 1 && frm.doc.is_closed !== 1) {
// // // //                 frm.set_value("is_closed", 1);
// // // //                 // Save and submit the document
// // // //                 frm.save().then(() => {
// // // //                     return frm.submit(); // Submit the document to set docstatus = 1
// // // //                 }).then(() => {
// // // //                     frappe.show_alert("Document saved and submitted successfully.");
// // // //                     if (ctx && ctx.so_name) {
// // // //                         setTimeout(() => {
// // // //                             frappe.set_route('Form', 'Sales Order', ctx.so_name);
// // // //                         }, 1000);
...
// // // //                     frappe.msgprint({
// // // //                         title: __("Error"),
// // // //                         message: __("Failed to save or submit the document. Please try again."),
// // // //                         indicator: "red"
// // // //                     });
...
// // // //             frappe.msgprint({
// // // //                 title: __("Error"),
// // // //                 message: __("An error occurred while processing the save operation."),
// // // //                 indicator: "red"
// // // //             });
// // // //         }
// // // //     },
...
// //                             // Save and set is_closed
// //                             frm.save().then(() => {
// //                                 return frm.set_value("is_closed", 1);
// //                             }).then(() => {
// //                                 return frm.save(); // Save again to persist is_closed
// //                             }).then(() => {
...
// //         // Initialize attribute meta if not Buttone
// //         if (!frm.__attribute_meta_initialized) {
// //             frm.__attribute_meta__ = {};
// //             frm.__attribute_meta_loaded__ = false;
// //             frm.__attribute_meta_initialized = true;
...
// //             // Handle item verification and Sales Order update
// //             const item_code = frm.doc.created_item || frm.doc.item_code;
// //             if (!item_code) {
// //                 throw new Error("No item code found to verify.");
// //             }

// //             // Verify item exists in Item doctype
// //             frappe.call({
// //                 method: "frappe.client.get",
// //                 args: {
// //                     doctype: "Item",
...
// //                         frappe.msgprint({
// //                             title: __("Error"),
// //                             message: __("Item " + item_code + " not found in Item doctype."),
// //                             indicator: "red"
// //                         });
// //                         return;
// //                     }

// //                     // Update is_closed if is_create_with_sales_order = 1
// //                     let save_promise = Promise.resolve();
// //                     if (frm.doc.is_create_with_sales_order === 1 && frm.doc.is_closed !== 1) {
// //                         save_promise = frm.set_value("is_closed", 1).then(() => {
// //                             return frm.save();
// //                         });
// //                     }

// //                     // Update Sales Order line item if ctx exists
// //                     save_promise.then(() => {
// //                         if (ctx && ctx.so_name && ctx.cdn) {
// //                             frappe.call({
...
// //                                 callback: function(r) {
// //                                     if (r && !r.exc) {
// //                                         frappe.show_alert("Sales Order updated with item " + item_code);
...
// //                                         frappe.msgprint({
// //                                             title: __("Error"),
// //                                             message: __("Failed to update Sales Order item."),
// //                                             indicator: "red"
// //                                         });
// //                                     }
// //                                 }
// //                             });
// //                         } else if (frm.doc.is_create_with_sales_order === 1) {
// //                             frappe.show_alert("Document saved successfully.");
// //                         }
// //                     }).catch((err) => {
// //                         frappe.msgprint({
...
// //             frappe.msgprint({
// //                 title: __("Error"),
// //                 message: __("An error occurred while processing the save operation: " + e.message),
// //                 indicator: "red"
// //             });
// //         }
// //     },
...
//                 }
//                 // Show "Save and Close" button
//                 // In the refresh function, replace the Save And Close button handler:
//                 frm.add_custom_button("Save And Close", function() {
//                     let dialog = frappe.confirm(
...
//                                 console.log("Document saved, now executing after_save logic");
                                
//                                 // The after_save function will automatically be called by Frappe
...
//     // after_save: function (frm) {
//     //     try {
//     //         console.log("Entering after_save function");
    
//     //         // Prevent duplicate/recursive execution
...
//     //         // Reset lock after 3s just in case
//     //         setTimeout(() => { frm.__after_save_lock = false; }, 3000);
...
//     //             frappe.msgprint({
//     //                 title: __("Error"),
//     //                 message: __("No item code found. Please ensure an item is generated."),
//     //                 indicator: "red"
//     //             });
//     //             return;
//     //         }
...
//     //                 // Load Sales Order context if available
//     //                 let ctx = null;
//     //                 const raw = sessionStorage.getItem('ig_return_context');
//     //                 if (raw) {
//     //                     try {
...
//     //                         frappe.msgprint({
//     //                             title: __("Error"),
//     //                             message: __("Invalid context data in sessionStorage."),
//     //                             indicator: "red"
//     //                         });
//     //                         return;
//     //                     }
...
//     //                 // Handle Sales Order linked flow
//     //                 if (frm.doc.is_create_with_sales_order === 1 && frm.doc.is_closed !== 1) {
//     //                     console.log("Closing Item Generator linked with Sales Order");
    
//     //                     frappe.run_serially([
//     //                         // Instead of frm.save() → use db.set_value to avoid after_save recursion
//     //                         () => frappe.db.set_value("Item Generator", frm.doc.name, "is_closed", 1),
//     //                         () => {
//     //                             if (ctx && ctx.so_name && ctx.cdn) {
//     //                                 return frappe.call({
//     //                                     method: "frappe.client.set_value",
...
//     //                                                 'ig_return_result',
//     //                                                 JSON.stringify({ so_name: ctx.so_name, cdn: ctx.cdn, item_code })
//     //                                             );
//     //                                             sessionStorage.removeItem('ig_return_context');
//     //                                             frappe.set_route('Form', 'Sales Order', ctx.so_name);
//     //                                         }
...
//     //                             } else {
//     //                                 frappe.show_alert({
//     //                                     message: __("Closed successfully but Sales Order update skipped (no context)"),
//     //                                     indicator: "orange"
//     //                                 });
//     //                             }
//     //                         }
...
//     //         frappe.msgprint({
//     //             title: __("Error"),
//     //             message: __("An error occurred: " + e.message),
//     //             indicator: "red"
//     //         });
//     //     }
//     // },    
...
//                             console.log("Updating Sales Order item:", context.cdn);
...
//                                     if (update_res && !update_res.exc) {
//                                         console.log("Sales Order item updated successfully");
...
//                                         // Close Item Generator if it's linked to Sales Order
//                                         if (frm.doc.is_create_with_sales_order === 1 && frm.doc.is_closed !== 1) {
//                                             frappe.call({
//                                                 method: "frappe.client.set_value",
//                                                 args: {
...
//                                         }
//                                     } else {
//                                         console.error("Failed to update Sales Order item");
//                                         frappe.msgprint({
//                                             title: __("Error"),
//                                             message: __("Failed to update Sales Order with new item"),
//                                             indicator: "red"
//                                         });
//                                     }
//                                     frm.__after_save_lock = false;
...
//                             });
//                         } else {
//                             // No Sales Order context, just show success
...
//         // Start verification process with a small delay to allow backend processing
//         setTimeout(() => {
...
//                 // Retry after delay
//                 console.log(`⏳ Item not found, retrying... (${retry_count + 1}/${max_retries})`);
//                 setTimeout(() => {
//                     verify_item_creation(item_code, retry_count + 1, callback);
//                 }, retry_delay);
//             } else {
//                 // Max retries reached
//                 console.error("❌ Item verification failed after", max_retries, "retries");
//                 callback(false);
//             }
//         },
//         error: function(err) {
//             if (retry_count < max_retries) {
//                 console.log(`⏳ API error, retrying... (${retry_count + 1}/${max_retries})`);
//                 setTimeout(() => {
//                     verify_item_creation(item_code, retry_count + 1, callback);
//                 }, retry_delay);
//             } else {
//                 console.error("❌ Item verification failed with API error:", err);
//                 callback(false);
//             }
//         }
//     });
...
//     const raw = sessionStorage.getItem('ig_return_context');
//     if (!raw) {
//         console.log("⚠️ No return context found");
//         frappe.show_alert({
...
//         console.log("⚠️ Incomplete return context");
//         frappe.show_alert({
...
//     console.log("🔄 Updating Sales Order Item:", context.cdn, "with item:", item_code);
...
//                 // Also update item_name if available
//                 frappe.call({
...
//                                     },
//                                     callback: function() {
//                                         console.log("✅ Sales Order Item details updated");
//                                         callback(true);
//                                     }
//                                 });
//                             } else {
...
//                 });
//             } else {
//                 console.error("❌ Failed to update Sales Order Item:", r);
//                 callback(false);
//             }
//         },
//         error: function(err) {
//             console.error("❌ API error updating Sales Order Item:", err);
//             callback(false);
//         }
//     });
// }
