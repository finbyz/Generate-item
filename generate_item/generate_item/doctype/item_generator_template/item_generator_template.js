...
// frappe.ui.form.on("Item Generator Template", {
...
//     // disable form actions (save, delete, menu)
//     frm.disable_form();
...
//             frm.page.set_primary_action(null);  // removes the primary action
//         }
//         $(".btn-primary").remove();  // removes Save button from DOM
//     }
// }
