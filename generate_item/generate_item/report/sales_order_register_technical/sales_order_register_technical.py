...
def get_columns():
    columns = [
        ...
        {"label": _("Unit Rate"), "fieldname": "unit_rate", "fieldtype": "Currency", "width": 100,"hidden": 1},
        {"label": _("Item Basic Amount INR"), "fieldname": "item_basic_amount_inr", "fieldtype": "Currency", "width": 120,"hidden": 1},
        {
			"label": _("Item ID"),
			"fieldname": "item_id",
			"fieldtype": "Data",
