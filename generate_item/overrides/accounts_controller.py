...
def update_child_qty_rate(parent_doctype, trans_items, parent_doctype_name, child_docname="items"):
	...
	def check_doc_permissions(doc, perm_type="create"):
		# Allow Update Items dialog to bypass permission checks
	...
	for d in data:
		...
		# Persist custom fields that might be mandatory via customization
		for custom_field in ("po_line_no", "line_remark", "tag_no", "description", "custom_shipping_address"):
			if custom_field in d:
				child_item.set(custom_field, d.get(custom_field))
